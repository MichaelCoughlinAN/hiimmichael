...
if __name__ == '__main__':
    ...
    try:
        ...
        client = boto3.client("sns", aws_access_key_id=access_key_id, aws_secret_access_key=secret_access_key, region_name='us-east-1')
        ...
        if beers_removed_count > 0 or beers_added_count > 0:
            ...
            if beers_removed_count > 0:
                ...
                for beer in beers_removed:
                    removed_beer = saved_beers[beer]
                    # print(beer + ' ' + this_beer[0] + ' ' + this_beer[1])
                    message = message + beer + ' ' + removed_beer[1] + ' ' + removed_beer[0] + '\n'
            ...
            if beers_added_count > 0:
                ...
                for beer in beers_added:
                    added_beer = current_beers[beer]
                    message = message + beer + ' ' + added_beer[1] + ' ' + added_beer[0] + '\n'
                    # print(beer + ' ' + this_beer[0] + ' ' + this_beer[1])
