...
int main(void)
{
    ...
    int winWidth = 800;
    float aspectRatio = 1.0; // square 
    int winHeight = winWidth * aspectRatio;
    
    GLFWwindow* window = glfwCreateWindow(winWidth, winHeight, "Lab 2 Example", NULL, NULL);
    if (!window) {
    ...
    SingleTriangle_ClipCoordinate_Scene *testScene = new SingleTriangle_ClipCoordinate_Scene();
