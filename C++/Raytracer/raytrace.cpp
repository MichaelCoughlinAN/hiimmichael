...
{ 
    ...
    spheres.push_back(new Sphere<double>(Vector3D<double>(1, -1, -18), 1, Vector3D<double>(1.0, 1.0, 1.0), 0.9, 0.9));
    // spheres.push_back(new Sphere<double>(Vector3D<double>(-2, 2, -15), 2, Vector3D<double>(0.1, 0.1, 1.0), 0.05, 0.5));
     spheres.push_back(new Sphere<double>(Vector3D<double>(-4, 3, -18), 1, Vector3D<double>(0.1, 1.0, 0.1), 0.3, 0.7));

    spheres.push_back(new Sphere<double>(Vector3D<double>(-4, 0, -25), 1, Vector3D<double>(1.00, 0.1, 0.1), 0.65, 0.95));
  // spheres.push_back(new Sphere<double>(Vector3D<double>(-1, 1, -25), 2, Vector3D<double>(1.0, 1.0, 1.0), 0.0, 0.0));
    spheres.push_back(new Sphere<double>(Vector3D<double>(2, 2, -25), 1, Vector3D<double>(0.1, 0.1, 1.0), 0.05, 0.5));
   // spheres.push_back(new Sphere<double>(Vector3D<double>(5, 3, -25), 2, Vector3D<double>(0.1, 1.0, 0.1), 0.3, 0.7));
